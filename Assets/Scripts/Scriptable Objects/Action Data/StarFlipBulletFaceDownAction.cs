...
public class StarFlipBulletFaceDownAction : BaseAction
{
    public override void OnActivated()
    {
        ...
        PopupManager.Instance.DisplayPopup("Choose a bullet to flip face-down.", "Cancel", popupLocation, GameManager.Instance.ActivePlayer.SightController.CancelSpaceSelection);
